...
public class View {
	...
	public static final String ADMIN_BOOKING_LIST = "admin/bookingList.jsp";
	public static final String ADMIN_BOOKING_VIEW = "admin/bookingView.jsp";
	...
	public static final String ADMIN_FLIGHT_LIST_SERVLET = "flight";
	public static final String ADMIN_PLACE_LIST_SERVLET = "place";
	public static final String ADMIN_AIRLINE_LIST_SERVLET = "airline";
	public static final String ADMIN_BOOKING_LIST_SERVLET = "booking";
