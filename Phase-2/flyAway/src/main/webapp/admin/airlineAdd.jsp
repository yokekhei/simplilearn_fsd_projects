        ...
        <form action="${pageContext.request.contextPath}/airline?action=add" method="post" class="needs-validation" novalidate>
          <div class="row">
            <div class="col">
              ...
              <input type="text" class="form-control" name="airlineCode" placeholder="123" value="" autocomplete="off" required />
          ...
          <div class="row">
             <div class="col">
              ...
              <input type="text" class="form-control" name="flightCode" placeholder="AB" value="" autocomplete="off" required />
              <div class="invalid-feedback">
          ...
          <div class="row">
             <div class="col">
              ...
              <input type="text" class="form-control" name="companyName" placeholder="" value="" autocomplete="off" required />
              <div class="invalid-feedback">
