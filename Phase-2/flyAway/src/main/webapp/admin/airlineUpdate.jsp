<script type="text/javascript">
	$(document).ready(function() {
		$('#modalAirlineUpdate').on('show.bs.modal', function (e) {
...
<div class="modal fade" id="modalAirlineUpdate">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="${pageContext.request.contextPath}/airline?action=update" method="post" class="needs-validation" novalidate>
          <div class="row">
            <div class="col">
              <label for="airlineCode">Airline Code</label>
              <input type="text" class="form-control airlineCode" name="airlineCode" placeholder="123" required readonly />
          ...
          <div class="row">
             <div class="col">
              ...
              <input type="text" class="form-control country" name="country" placeholder="" required />
              <div class="invalid-feedback">
