...
@Component({
  selector: 'app-tester-quiz-details',
  templateUrl: './tester-quiz-details.component.html',
  styleUrls: ['./tester-quiz-details.component.scss']
})
export class TesterQuizDetailsComponent implements OnInit, OnDestroy {
